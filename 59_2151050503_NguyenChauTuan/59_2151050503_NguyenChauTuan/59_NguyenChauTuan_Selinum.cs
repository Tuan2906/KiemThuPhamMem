...
namespace _59_2151050503_NguyenChauTuan
{
    ...
    {
        private IWebDriver driver_59_Tuan;// khai báo IwebDriver
        public IWebDriver init_59_Tuan()// Hàm khởi tạo IwebDriver
        {
            ...
            driver_59_Tuan.Navigate().GoToUrl("https://www.ivivu.com/ve-may-bay/thong-tin-hanh-khach/2583947");// di chuyển đến đường dẫn được chỉ địnj
