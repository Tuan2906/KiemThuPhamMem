...
namespace _59_2151050503_NguyenChauTuan
{
    ...
    {
        private ChromeDriver driver_59_Tuan;// khai báo chormdriver
        ...
        public void selinum_ThongTinLienHe_TC1_59_NCT()
        {
                ...
                driver_59_Tuan = init_59_NCT();// gọi hàm khởi tạo
                driver_59_Tuan.FindElement(By.Name("fullName")).SendKeys("Nguyen Tuấn Châu");
                driver_59_Tuan.FindElement(By.Name("phone")).SendKeys("0902212777");
                driver_59_Tuan.FindElement(By.XPath("/html/body/app-root/app-passenger/div/div/div/section/div/div/passenger-info/div[1]/div/div/div/form/div/div[2]/div/div/div[7]/button")).Click();
                Thread.Sleep(10000);
                driver_59_Tuan.Close();
        ...
        public void selinum_ThongTinLienHe_TC2_59_NCT()
        {
            ...
            driver_59_Tuan.FindElement(By.Name("fullName")).SendKeys("");// nhập họ và tên là rỗng
            driver_59_Tuan.FindElement(By.Name("phone")).SendKeys("0925890292");// nhập số điện thoại
            driver_59_Tuan.FindElement(By.XPath("/html/body/app-root/app-passenger/div/div/div/section/div/div/passenger-info/div[1]/div/div/div/form/div/div[2]/div/div/div[7]/button")).Click();// nhấn nút button là nhập thông tin hành khách
        ...
        public void selinum_ThongTinLienHe_TC3_59_NCT()
        {
            ...
            selected.SelectByIndex(2);// tlấy selected có vị trí là 1 nu
             driver_59_Tuan.FindElement(By.Name("fullName")).SendKeys("Nguyen Châu Tuấn");// nhập họ và tên là 
             driver_59_Tuan.FindElement(By.Name("phone")).SendKeys("");
             driver_59_Tuan.FindElement(By.XPath("/html/body/app-root/app-passenger/div/div/div/section/div/div/passenger-info/div[1]/div/div/div/form/div/div[2]/div/div/div[7]/button")).Click();
            Thread.Sleep(10000);
             driver_59_Tuan.Close();
        ...
        {
             driver_59_Tuan = init_59_NCT();
            var select =  driver_59_Tuan.FindElement(By.Name("gender"));
            var selected = new SelectElement(select);
            selected.SelectByIndex(1);
             driver_59_Tuan.FindElement(By.Name("fullName")).SendKeys("Tuấn");
             driver_59_Tuan.FindElement(By.Name("phone")).SendKeys("0925890292");
             driver_59_Tuan.FindElement(By.XPath("/html/body/app-root/app-passenger/div/div/div/section/div/div/passenger-info/div[1]/div/div/div/form/div/div[2]/div/div/div[7]/button")).Click();
            Thread.Sleep(10000);
             driver_59_Tuan.Close();
        ...
        public void selinum_ThongTinLienHe_TC5_59_NCT()
        {
            ...
            selected.SelectByIndex(2);
             driver_59_Tuan.FindElement(By.Name("fullName")).SendKeys("Châu Tuấn");
             driver_59_Tuan.FindElement(By.Name("phone")).SendKeys("113");
             driver_59_Tuan.FindElement(By.XPath("/html/body/app-root/app-passenger/div/div/div/section/div/div/passenger-info/div[1]/div/div/div/form/div/div[2]/div/div/div[7]/button")).Click();
            Thread.Sleep(10000);
             driver_59_Tuan.Close();
    ...
    public class _59_NguyenChauTuan_Selinum_DangKy
    {
        ...
        private ChromeDriver  driver_59_Tuan;// khai báo  driver_59_Tuan kiểu ChromeDriver
        ...
        public void selinum_DangKy_TC1_59_NCT()
        {
             ...
             driver_59_Tuan = init_59_NCT();// gọi hàm 
            ...
            Thread.Sleep(2000);// dừng 2s
             ...
             driver_59_Tuan.FindElement(By.XPath("//*[@id='RegisterModal']/div/div[2]/form/div/div[2]/div/input")).SendKeys("12345"); ;//gửi dl vào input voi XPath
             driver_59_Tuan.FindElement(By.XPath("//*[@id='RegisterModal']/div/div[2]/form/div/div[3]/div/input")).SendKeys("12345"); ;//gửi dl vào input voi XPath
        ...
        public void selinum_DangKy_TC2_59_NCT()
        {
             ...
             driver_59_Tuan = init_59_NCT();
             driver_59_Tuan.FindElement(By.CssSelector("#UserLogin > a")).Click();
             driver_59_Tuan.FindElement(By.XPath("//*[@id='UserLogin']/ul/li[2]/span")).Click();
             driver_59_Tuan.Manage().Timeouts().ImplicitWait = TimeSpan.FromSeconds(10);
             driver_59_Tuan.FindElement(By.Name("EmailDK")).SendKeys("tuanchaunguyen13@gmail.com");
             driver_59_Tuan.FindElement(By.XPath("//*[@id='RegisterModal']/div/div[2]/form/div/div[2]/div/input")).SendKeys("12345");
             driver_59_Tuan.FindElement(By.XPath("//*[@id='RegisterModal']/div/div[2]/form/div/div[3]/div/input")).SendKeys("12345");
            IWebElement checkbox =  driver_59_Tuan.FindElement(By.CssSelector("#policy-checkbox"));
            ((IJavaScriptExecutor)  driver_59_Tuan).ExecuteScript("arguments[0].click();", checkbox);

             driver_59_Tuan.FindElement(By.XPath("//*[@id='RegisterModal']/div/div[2]/form/div/div[5]/button")).Click();
            var screenshot = ((ITakesScreenshot)  driver_59_Tuan).GetScreenshot();
