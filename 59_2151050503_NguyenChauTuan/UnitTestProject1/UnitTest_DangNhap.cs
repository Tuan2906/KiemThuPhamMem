...
namespace _59_2151050503_NguyenChauTuan_Unitest
{
    ...
    public class UnitTest_DangNhap
    {
        ...
        [TestMethod]
        [DataSource("Microsoft.VisualStudio.TestTools.DataSource.CSV", @"..\\..\\DataTest\\testDangNhap.csv", "testDangNhap#csv", DataAccessMethod.Sequential)]// đọc file test.csv trong thư mục Data
       // [TestMethod]
        public void DangNhap()
        {
            ...
            string result_59_NguyenChauTuan = "Failed";
            if (actual_59_NguyenChauTuan == expected_59_NguyenChauTuan)
            {
                result_59_NguyenChauTuan = "Passed";// nếu kết quả asesrt trả ra hợp lệ thì cập nhật true cho reult

            }

            // Write the test result to a CSV file
            string filePath_59_NguyenChauTuan = @"..\\..\\DataTest\test_results.csv";// gán đường dẫn filepath để lưu
